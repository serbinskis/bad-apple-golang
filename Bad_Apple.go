...
func (apple *BadApple) FindNearest(color int) termbox.Attribute {
	nearest := int(^uint(0) >> 1) 
	var best termbox.Attribute

	for i := 0; i < len(apple.Colors); i++ {
		distance := Abs(color - apple.Colors[i].colorInteger)
		if distance < nearest {
			nearest = distance
...
func main() {
	...
	apple.Colors = append(apple.Colors, Color{789516, termbox.ColorBlack})
	//apple.Colors = append(apple.Colors, Color{12914463, termbox.ColorRed})
	//apple.Colors = append(apple.Colors, Color{1286414, termbox.ColorGreen})
	//apple.Colors = append(apple.Colors, Color{12688384, termbox.ColorYellow})
	//apple.Colors = append(apple.Colors, Color{14298, termbox.ColorBlue})
	//apple.Colors = append(apple.Colors, Color{8918936, termbox.ColorMagenta})
	//apple.Colors = append(apple.Colors, Color{3839709, termbox.ColorCyan})
	apple.Colors = append(apple.Colors, Color{13421772, termbox.ColorWhite})
